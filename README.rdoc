...
{helpers/crud/control.rb}[http://codez.ch/dry_crud?q=Crud::Control]:: Representation of a single form control consisting of a label, input field, addon or help text.
