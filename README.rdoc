...
{test/support/crud_test_model.rb}[http://codez.ch/dry_crud?q=CrudTestHelper]:: A dummy model to run CRUD tests against.
...
{spec/support/crud_test_model.rb}[http://codez.ch/dry_crud?q=CrudTestHelper]:: A dummy model to run CRUD tests against.
