...
* To use standard formatting, tables and forms throughout your application, add <tt>helper :standard</tt> to your +ApplicationController+ and benefit from these little helper methods. 
* Add a +:label+ method to your models for a human-friendly representation.

ATTENTION: This is the master branch on its way to get ready for Rails 3. If you need a working version for Rails 2.3.x, please go to the rails-2.3 branch or get the released dry_crud gem version 0.6.0.
...
The gem was developed with Rails 2.3.8, we plan to reach a fully compatible version 1.0 when Rails 3 has come out.
