...
This is the master branch on its way to get ready for Rails 3. If you need a working version for Rails 2.3.x, please go to the rails-2.3 branch or get the released dry_crud gem version 0.6.0.
